...
const ASSETS = [
  ...
  '/hebrew-uno-game/js/firebase-config.js',
  '/hebrew-uno-game/js/online.js',
  '/hebrew-uno-game/js/online-host.js',
  '/hebrew-uno-game/js/online-guest.js'
];
